...
RESTART___TEXT		:= 0x500000000000
RESTART___DATA		:= 0x500000008000
RESTART___DATA_CONST	:= 0x50000000c000
RESTART___LINKEDIT	:= 0x500000010000
RESTART_STACK		:= 0x500001010000
...
$(BUILD)/xnd_restart_internal: $(XND_RESTART_INTERNAL_SOURCES) | $(BUILD)
	...
	-Wl,-segaddr,__TEXT,$(RESTART___TEXT) \
	-Wl,-segaddr,__DATA,$(RESTART___DATA) \
	-Wl,-segaddr,__DATA_CONST,$(RESTART___DATA_CONST) \
	-Wl,-segaddr,__LINKEDIT,$(RESTART___LINKEDIT) \
	-Wl,-ld_classic \
	-o $@ $^
